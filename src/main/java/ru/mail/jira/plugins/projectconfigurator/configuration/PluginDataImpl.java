...
public class PluginDataImpl implements PluginData {
  ...
  private static final String PROJECT_CONFIGURATION_CF_ID =
      PLUGIN_PREFIX + "projectConfigurationCfId";
  ...
  public void setNotificationSchemeIds(List<String> notificationSchemeIds) {
    pluginSettingsFactory
        ...
        .put(NOTIFICATION_SCHEME_IDS, notificationSchemeIds);
  }
  ...
  public void setProjectConfigurationCfId(String projectConfigurationCfId) {
    pluginSettingsFactory
        .createGlobalSettings()
        .put(PROJECT_CONFIGURATION_CF_ID, projectConfigurationCfId);
  }
}
