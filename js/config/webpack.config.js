...
module.exports = {
    ...
    entry: {
        projectConfigurator: [require.resolve('./polyfills'), paths.resolveApp('src/app/index.jsx')],
    },
    output: {
        // The build folder.
        path: paths.appBuild,
        ...
        filename: '../../src/main/resources/ru/mail/jira/plugins/projectconfigurator/configurator/react/[name].js',
        chunkFilename: '../../src/main/resources/ru/mail/jira/plugins/projectconfigurator/configurator/react/[name].chunk.js',
        // Point sourcemap entries to original disk location (format as URL on Windows)
        devtoolModuleFilenameTemplate: info =>
            path
                .relative(paths.appSrc, info.absoluteResourcePath)
                .replace(/\\/g, '/'),
        jsonpFunction: 'projectConfiguratorWebpackJsonp' //override default jsonpFunction to avoid collision with other webpack apps
    },
    resolve: {
